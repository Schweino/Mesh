export type AccountInfoType = 'firstName' | 'middleName' | 'lastName' | 'accountNumber' | 'email' | 'mobileNumber' | 'companyName' | 'countryCode' | 'city' | 'postalCode' | 'address' | 'id' | 'dateOfBirth';
export interface ApiResult {
    readonly status?: 'ok' | 'serverFailure' | 'permissionDenied' | 'badRequest' | 'notFound' | 'conflict' | 'tooManyRequest' | 'locked' | 'unavailableForLegalReasons';
...
export type ApiResultStatus = 'ok' | 'serverFailure' | 'permissionDenied' | 'badRequest' | 'notFound' | 'conflict' | 'tooManyRequest' | 'locked' | 'unavailableForLegalReasons';
...
export interface B2BBrokerAuthRequest {
    ...
    mfaCode?: string | null;
    mfaType?: 'phone' | 'email' | 'totp' | 'phoneAndEmail' | 'requireNextSecurityQuestion' | 'readEmail' | 'face' | 'tradingPin' | 'qrCode' | 'password' | 'roaming' | 'mobile' | 'passkey';
...
export interface B2BBrokerAuthResponse {
    ...
    status?: 'failed' | 'challengeFailed' | 'succeeded' | 'challengeIssued' | 'mfaRequired' | 'openInBrokerModule' | 'delayed' | 'deviceConfirmationRequired' | 'emailVerification' | 'emailReceived' | 'captchaChallenge' | 'faceVerification' | 'bindMfaRequired' | 'apiKeyGenerationError' | 'qrCodeRequired' | 'qrCodeExpired' | 'deviceLoginVerified';
...
export interface BridgingTransferDetailsModel {
    status?: 'recordCreated' | 'registeredInProvider' | 'sourceTransferStarted' | 'inReview' | 'providerAwaitingSourceTransfer' | 'providerFundsReceived' | 'providerProcessingPayment' | 'providerProcessedPayment' | 'providerSetUndeliverable' | 'returned' | 'refundRegisteredInProvider' | 'providerAwaitingSourceRefundTransfer' | 'providerRefundFundsReceived' | 'providerProcessingRefundPayment' | 'providerProcessedRefundPayment' | 'refunded' | 'canceled' | 'failed';
...
export type BrokerAuthStatus = 'failed' | 'challengeFailed' | 'succeeded' | 'challengeIssued' | 'mfaRequired' | 'openInBrokerModule' | 'delayed' | 'deviceConfirmationRequired' | 'emailVerification' | 'emailReceived' | 'captchaChallenge' | 'faceVerification' | 'bindMfaRequired' | 'apiKeyGenerationError' | 'qrCodeRequired' | 'qrCodeExpired' | 'deviceLoginVerified';
...
export type ClientType = 'undefined' | 'wallet' | 'exchange' | 'vasp' | 'merchant' | 'other' | 'psp' | 'neobank' | 'iGaming' | 'aggregator';
...
export type CryptocurrencyFundingOptionType = 'existingCryptocurrencyBalance' | 'buyingPowerPurchase' | 'paymentMethodDepositUsage' | 'cryptocurrencyConversion' | 'stableCoinNoFeeConversion' | 'cryptocurrencyBuyingPowerConversion' | 'cryptocurrencyMultiStepConversion';
/**
...
export type DeviceType = 'unknown' | 'android' | 'ios' | 'web';
...
export interface ExecuteTransferResponse {
    ...
    status?: 'succeeded' | 'inProgress' | 'failed' | 'mfaRequired' | 'emailConfirmationRequired' | 'deviceConfirmationRequired' | 'mfaFailed' | 'addressWhitelistRequired' | 'secondMfaRequired' | 'deFiWalletConfirmationRequired' | 'emailConfirmationApprovalRequired';
...
export type ExecuteTransferStatus = 'succeeded' | 'inProgress' | 'failed' | 'mfaRequired' | 'emailConfirmationRequired' | 'deviceConfirmationRequired' | 'mfaFailed' | 'addressWhitelistRequired' | 'secondMfaRequired' | 'deFiWalletConfirmationRequired' | 'emailConfirmationApprovalRequired';
...
export type HoldingTransferIneligibilityReason = 'noEligibleNetworks' | 'symbolDoesNotMatch' | 'notSupportedForTransferByTarget' | 'notSupportedForTransferBySource' | 'eligibleWithFunding' | 'amountNotSufficient' | 'noPrice';
...
export interface IntegrationNetworksModelResponse {
    ...
    networks?: NetworkResponseWithSupportedDevices[] | null;
...
export type MfaType = 'phone' | 'email' | 'totp' | 'phoneAndEmail' | 'requireNextSecurityQuestion' | 'readEmail' | 'face' | 'tradingPin' | 'qrCode' | 'password' | 'roaming' | 'mobile' | 'passkey';
...
export interface NetworkResponseWithSupportedDevices {
    /**
     * The Id of the network in Mesh system. Should be used to initiate transfers.
     * @format uuid
     */
    ...
    /** The symbol of the network's native cryptocurrency. */
    nativeSymbol?: string | null;
    supportedDevices?: DeviceType[] | null;
}
export type NetworkTransferIneligibilityReason = 'amountNotSufficient' | 'gasFeeAssetBalanceNotEnough' | 'noTargetNetworkFound' | 'refusedByInstitution' | 'eligibleWithFunding' | 'balanceBelowRequestedAmount' | 'requestedAmountBelowMinimum' | 'balanceBelowMinimum' | 'requestedAmountBelowFees' | 'requestedAmountBelowClientMinimum' | 'requestedAmountAboveClientMaximum' | 'noPrice' | 'nyCoinbaseUserRestrictions' | 'gasFeeAssetAndBalanceNotEnough';
export type NetworkType = 'unknown' | 'evm' | 'solana' | 'bitcoin' | 'cardano' | 'tron' | 'avalancheX' | 'tezos' | 'dogecoin' | 'ripple' | 'stellar' | 'litecoin' | 'sui' | 'aptos' | 'tvm' | 'injective';
...
export interface QuoteFundingOption {
    ...
    fundingOption?: 'existingCryptocurrencyBalance' | 'buyingPowerPurchase' | 'paymentMethodDepositUsage' | 'cryptocurrencyConversion' | 'stableCoinNoFeeConversion' | 'cryptocurrencyBuyingPowerConversion' | 'cryptocurrencyMultiStepConversion';
...
export interface TransferToAddressWithAmount {
     ...
     * @format double
     */
    displayAmountInFiat?: number | null;
}
export interface TransferTravelRuleOptions {
    transferType?: TransferTypeEnum | null;
    clientName?: string | null;
    clientType?: 'undefined' | 'wallet' | 'exchange' | 'vasp' | 'merchant' | 'other' | 'psp' | 'neobank' | 'iGaming' | 'aggregator';
    /** @format uuid */
    clientId?: string;
}
...
export interface UpdateTransferResponse {
    ...
    statusDetails?: 'unknown' | 'failed' | 'frozen' | 'succeeded' | 'mfaRequired' | 'pending' | 'expired' | 'canceled' | 'waitingForSignature' | 'waitingForClearing' | 'awaitingApproval' | 'awaitingConfirmation' | 'awaitingVerification' | 'rejected' | 'pendingCancel' | 'emailVerification' | 'deviceConfirmationRequired' | 'mfaFailed' | 'addressWhitelistRequired' | 'secondMfaRequired' | 'emailConfirmationApprovalRequired' | 'travelRuleRequired';
    /** Error message, if the operation did not complete successfully. */
    errorMessage?: string | null;
    /** Result of the transfer initiation. */
...
export declare class FrontApi<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
    integrationsAccountInformation: {
         ...
         * @response `403` `any` Forbidden
         */
        v1ExchangeVerifyCreate: (data: ExchangeAccountInfoRequest, params?: RequestParams) => Promise<AxiosResponse<B2BBrokerAccountDetailsResponseApiResult, any>>;
    };
    assets: {
        /**
         * No description
    ...
    quickNode: {
         ...
         * @response `500` `void` Internal Server Error
         */
        v1CatalogSolanaGetLatestBlockhashCreate: (query?: {
            chainId?: string;
        }, params?: RequestParams) => Promise<AxiosResponse<StringApiResult, any>>;
        /**
         * No description
         *
         * @tags QuickNode
         ...
         * @response `500` `void` Internal Server Error
         */
        v1CatalogSolanaGetTokenProgramCreate: (query?: {
            chainId?: string;
            token?: string;
        }, params?: RequestParams) => Promise<AxiosResponse<StringApiResult, any>>;
        /**
         ...
         * @response `500` `void` Internal Server Error
         */
        v1CatalogSolanaIsTokenAddressCreatedCreate: (query?: {
            chainId?: string;
            address?: string;
        }, params?: RequestParams) => Promise<AxiosResponse<StringApiResult, any>>;
    };
    ...
    wallets: {
         ...
         * @response `401` `any` Unauthorized: Client Id or Client Secret are not correct or missing.
         */
        v1WalletsVerifyList: (query?: {
            /** User identifier. */
            UserId?: string;
            /** Address of the wallet. */
            Address?: string;
        }, params?: RequestParams) => Promise<AxiosResponse<DeFiWalletVerificationResponseApiResult, any>>;
    };
}
