...
var FrontApi = /** @class */ (function (_super) {
    ...
    function FrontApi() {
        ...
        _this.quickNode = {
             ...
             * @response `500` `void` Internal Server Error
             */
            v1CatalogSolanaGetTokenProgramCreate: function (query, params) {
                if (params === void 0) { params = {}; }
                return _this.request(__assign({ path: "/api/v1/catalog/solana/getTokenProgram", method: 'POST', query: query, secure: true, format: 'json' }, params));
            },
            /**
             * No description
             *
             ...
             * @response `500` `void` Internal Server Error
             */
            v1CatalogSolanaIsTokenAddressCreatedCreate: function (query, params) {
                if (params === void 0) { params = {}; }
                return _this.request(__assign({ path: "/api/v1/catalog/solana/isTokenAddressCreated", method: 'POST', query: query, secure: true, format: 'json' }, params));
            }
        };
        _this.transactions = {
            /**
