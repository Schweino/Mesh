...
var getStylesContent = function(style) {
...
function windowEndpoint(w, context = globalThis, targetOrigin2 = "*") {
  return {
    postMessage: (msg, transferables) => w.postMessage(msg, targetOrigin2, transferables),
...
_SolanaWalletAdapterWallet_listeners = /* @__PURE__ */ new WeakMap(), _SolanaWalletAdapterWallet_adapter = /* @__PURE__ */ new WeakMap(), _SolanaWalletAdapterWallet_supportedTransactionVersions = /* @__PURE__ */ new WeakMap(), _SolanaWalletAdapterWallet_chain = /* @__PURE__ */ new WeakMap(), _SolanaWalletAdapterWallet_endpoint = /* @__PURE__ */ new WeakMap(), _SolanaWalletAdapterWallet_account = /* @__PURE__ */ new WeakMap(), _SolanaWalletAdapterWallet_connect = /* @__PURE__ */ new WeakMap(), _SolanaWalletAdapterWallet_disconnect = /* @__PURE__ */ new WeakMap(), _SolanaWalletAdapterWallet_on = /* @__PURE__ */ new WeakMap(), _SolanaWalletAdapterWallet_signAndSendTransaction = /* @__PURE__ */ new WeakMap(), _SolanaWalletAdapterWallet_signTransaction = /* @__PURE__ */ new WeakMap(), _SolanaWalletAdapterWallet_signMessage = /* @__PURE__ */ new WeakMap(), _SolanaWalletAdapterWallet_signIn = /* @__PURE__ */ new WeakMap(), _SolanaWalletAdapterWallet_instances = /* @__PURE__ */ new WeakSet(), _SolanaWalletAdapterWallet_connected = function _SolanaWalletAdapterWallet_connected2() {
  const publicKey2 = __classPrivateFieldGet4(this, _SolanaWalletAdapterWallet_adapter, "f").publicKey?.toBytes();
  if (publicKey2) {
...
// node_modules/@meshconnect/uwc-bridge-parent/dist/BridgeParent.js
var BridgeParent = class {
  iframe;
  ...
  async initializeConnection() {
    ...
    this.endpoint = windowEndpoint(this.iframe.contentWindow, window, "*");
    expose(this.parentAPI, this.endpoint);
  ...
  getSolanaWallets() {
    ...
    const wallets2 = get2();
    const solanaWallets = [];
    const walletNames = /* @__PURE__ */ new Set();
        ...
        solanaWallets.push({
          ...
          adapter: adapter ? {
            ...
            signTransaction: async (transaction) => {
              return adapter.signTransaction !== void 0 ? await adapter.signTransaction(transaction) : new Error("Adapter does not support signTransaction");
            },
            signAllTransactions: async (transactions) => {
              return adapter.signAllTransactions !== void 0 ? await adapter.signAllTransactions(transactions) : new Error("Adapter does not support signAllTransactions");
            },
            signMessage: async (message) => {
              return adapter.signMessage !== void 0 ? await adapter.signMessage(message) : new Error("Adapter does not support signMessage");
            },
            signIn: async (input) => {
              return adapter.signIn !== void 0 ? await adapter.signIn(input) : new Error("Adapter does not support signIn");
            },
            customFunctions: [
            ...
            signSerializedTransaction: async (transaction) => {
              if (adapter.signTransaction === void 0) {
            ...
            signAllSerializedTransactions: async (transactions) => {
              if (adapter.signAllTransactions === void 0) {
...
function addLanguage(linkUrl, language) {
  if (language === "system") {
    language = typeof navigator !== "undefined" && navigator.language ? encodeURIComponent(navigator.language) : void 0;
  }
...
//# sourceMappingURL=@meshconnect_web-link-sdk.js.map
